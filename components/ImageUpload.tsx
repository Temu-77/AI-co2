      ...
      <div className="bg-gradient-to-r from-purple-900/30 to-blue-900/30 backdrop-blur-xl border border-purple-500/30 rounded-2xl p-4 sm:p-6">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm sm:text-base text-gray-300">
            This calculator assumes your uploaded image was generated by <span className="font-semibold text-purple-400">MugenAI Ads 2</span>
          </p>
          <div className="flex flex-wrap justify-center gap-2 text-xs text-gray-400">
            <span className="bg-purple-500/20 px-2 py-1 rounded-full">GPT-o3 Image Gen</span>
            <span className="bg-blue-500/20 px-2 py-1 rounded-full">Gemini 2.0 Prompt Gen</span>
            <span className="bg-cyan-500/20 px-2 py-1 rounded-full">Tokyo Server</span>
          </div>
        </div>
      </div>
